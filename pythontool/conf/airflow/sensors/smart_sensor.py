...
from pythontool.conf.airflow.exceptions import AirflowException, AirflowTaskTimeout
from pythontool.conf.airflow.models import BaseOperator, DagRun, SensorInstance, SkipMixin, TaskInstance
from pythontool.conf.airflow.settings import LOGGING_CLASS_PATH
from pythontool.conf.airflow.stats import Stats
from pythontool.conf.airflow.utils import helpers, timezone
from pythontool.conf.airflow.utils.context import Context
from pythontool.conf.airflow.utils.email import send_email
from pythontool.conf.airflow.utils.log.logging_mixin import set_context
...
from pythontool.conf.airflow.utils.state import PokeState, State
...
class SensorWork:
    ...
    def create_new_task_handler():
        ...
        :return: log handler
        """
        from pythontool.conf.airflow.utils.log.secrets_masker import _secrets_masker
