...
from pythontool.conf.airflow.models import BaseOperatorLink, DagBag, DagModel, DagRun, TaskInstance
...
class ExternalTaskSensor(BaseSensorOperator):
    ...
    def _handle_execution_date_fn(self, context) -> Any:
        ...
        """
        from pythontool.conf.airflow.utils.operator_helpers import make_kwargs_callable
