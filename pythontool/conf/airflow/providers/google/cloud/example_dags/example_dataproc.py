...
from pythontool.conf.airflow.providers.google.cloud.operators.dataproc import (
    ClusterGenerator,
...
from pythontool.conf.airflow.providers.google.cloud.sensors.dataproc import DataprocJobSensor
