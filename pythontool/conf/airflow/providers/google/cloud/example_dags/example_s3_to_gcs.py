...
from pythontool.conf.airflow.providers.amazon.aws.operators.s3 import S3CreateBucketOperator, S3DeleteBucketOperator
from pythontool.conf.airflow.providers.google.cloud.operators.gcs import GCSCreateBucketOperator, GCSDeleteBucketOperator
from pythontool.conf.airflow.providers.google.cloud.transfers.s3_to_gcs import S3ToGCSOperator
