...
from pythontool.conf.airflow.providers.google.cloud.hooks.compute_ssh import ComputeEngineSSHHook
from pythontool.conf.airflow.providers.ssh.operators.ssh import SSHOperator
