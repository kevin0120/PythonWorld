...
from pythontool.conf.airflow.providers.google.cloud.transfers.gcs_to_sftp import GCSToSFTPOperator
from pythontool.conf.airflow.providers.sftp.sensors.sftp import SFTPSensor
