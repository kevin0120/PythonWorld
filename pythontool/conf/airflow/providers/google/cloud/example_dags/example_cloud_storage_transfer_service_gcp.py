...
from pythontool.conf.airflow.providers.google.cloud.operators.cloud_storage_transfer_service import (
...
from pythontool.conf.airflow.providers.google.cloud.sensors.cloud_storage_transfer_service import (
