...
from pythontool.conf.airflow.providers.google.cloud.hooks.cloud_storage_transfer_service import (
    ACCESS_KEY_ID,
    AWS_ACCESS_KEY,
    AWS_S3_DATA_SOURCE,
    BUCKET_NAME,
...
from pythontool.conf.airflow.providers.google.cloud.utils.helpers import normalize_directory_path
