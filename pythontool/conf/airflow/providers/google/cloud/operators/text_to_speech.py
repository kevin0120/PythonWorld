...
from pythontool.conf.airflow.providers.google.cloud.hooks.text_to_speech import CloudTextToSpeechHook
from pythontool.conf.airflow.providers.google.common.links.storage import FileDetailsLink
