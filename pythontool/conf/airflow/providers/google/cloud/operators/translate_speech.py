...
from pythontool.conf.airflow.providers.google.cloud.hooks.speech_to_text import CloudSpeechToTextHook
from pythontool.conf.airflow.providers.google.cloud.hooks.translate import CloudTranslateHook
