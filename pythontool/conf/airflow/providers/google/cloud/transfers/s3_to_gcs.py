...
from pythontool.conf.airflow.providers.google.cloud.hooks.gcs import GCSHook, _parse_gcs_url, gcs_object_is_directory

try:
    from pythontool.conf.airflow.providers.amazon.aws.operators.s3 import S3ListOperator
except ImportError:
    from pythontool.conf.airflow.providers.amazon.aws.operators.s3_list import S3ListOperator
