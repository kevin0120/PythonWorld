...
from pythontool.conf.airflow.providers.google.marketing_platform.operators.campaign_manager import (
...
from pythontool.conf.airflow.providers.google.marketing_platform.sensors.campaign_manager import (
