...
from pythontool.conf.airflow.providers.amazon.aws.operators.redshift_sql import RedshiftSQLOperator
from pythontool.conf.airflow.providers.amazon.aws.transfers.s3_to_redshift import S3ToRedshiftOperator
