...
from pythontool.conf.airflow.providers.amazon.aws.operators.emr import EmrCreateJobFlowOperator
from pythontool.conf.airflow.providers.amazon.aws.sensors.emr import EmrJobFlowSensor
