...
from pythontool.conf.airflow.providers.amazon.aws.hooks.dynamodb import DynamoDBHook
from pythontool.conf.airflow.providers.amazon.aws.transfers.hive_to_dynamodb import HiveToDynamoDBOperator
