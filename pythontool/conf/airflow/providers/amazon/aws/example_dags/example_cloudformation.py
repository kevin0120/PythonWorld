...
from pythontool.conf.airflow.providers.amazon.aws.operators.cloud_formation import (
    CloudFormationCreateStackOperator,
    CloudFormationDeleteStackOperator,
)
from pythontool.conf.airflow.providers.amazon.aws.sensors.cloud_formation import (
...
CLOUDFORMATION_TEMPLATE = {
    'Description': 'Stack from pythontool.conf.airflow CloudFormation example DAG',
    'Resources': {
        'ExampleQueue': {
            'Type': 'AWS::SQS::Queue',
        }
