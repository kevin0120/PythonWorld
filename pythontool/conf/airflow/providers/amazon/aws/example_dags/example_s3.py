...
from pythontool.conf.airflow.providers.amazon.aws.operators.s3 import (
...
from pythontool.conf.airflow.providers.amazon.aws.sensors.s3 import S3KeySensor, S3KeysUnchangedSensor
