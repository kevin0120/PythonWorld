...
from pythontool.conf.airflow.providers.amazon.aws.hooks.eks import ClusterStates, NodegroupStates
...
from pythontool.conf.airflow.providers.amazon.aws.sensors.eks import EksClusterStateSensor, EksNodegroupStateSensor
