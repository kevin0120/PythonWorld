...
from pythontool.conf.airflow.providers.amazon.aws.hooks.dms import DmsHook
...
class DmsCreateTaskOperator(BaseOperator):
    ...
    def execute(self, context: 'Context'):
        """
        Creates AWS DMS replication task from pythontool.conf.airflow
...
class DmsDeleteTaskOperator(BaseOperator):
    ...
    def execute(self, context: 'Context'):
        """
        Deletes AWS DMS replication task from pythontool.conf.airflow
...
class DmsDescribeTasksOperator(BaseOperator):
    ...
    def execute(self, context: 'Context'):
        """
        Describes AWS DMS replication tasks from pythontool.conf.airflow
...
class DmsStartTaskOperator(BaseOperator):
    ...
    def execute(self, context: 'Context'):
        """
        Starts AWS DMS replication task from pythontool.conf.airflow
...
class DmsStopTaskOperator(BaseOperator):
    ...
    def execute(self, context: 'Context'):
        """
        Stops AWS DMS replication task from pythontool.conf.airflow
