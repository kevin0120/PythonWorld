...
from pythontool.conf.airflow.providers.amazon.aws.hooks.emr import EmrHook
...
from pythontool.conf.airflow.providers.amazon.aws.hooks.emr import EmrContainerHook
