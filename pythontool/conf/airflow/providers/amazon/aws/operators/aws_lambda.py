...
from pythontool.conf.airflow.providers.amazon.aws.hooks.lambda_function import LambdaHook
...
class AwsLambdaInvokeFunctionOperator(BaseOperator):
    ...
    def execute(self, context: 'Context'):
        """
        Invokes the target AWS Lambda function from pythontool.conf.airflow.
