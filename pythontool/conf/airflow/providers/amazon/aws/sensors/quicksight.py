...
from pythontool.conf.airflow.providers.amazon.aws.hooks.quicksight import QuickSightHook
from pythontool.conf.airflow.providers.amazon.aws.hooks.sts import StsHook
