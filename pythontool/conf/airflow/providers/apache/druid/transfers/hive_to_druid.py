...
from pythontool.conf.airflow.providers.apache.druid.hooks.druid import DruidHook
from pythontool.conf.airflow.providers.apache.hive.hooks.hive import HiveCliHook, HiveMetastoreHook
