...
from pythontool.conf.airflow.security import utils
from pythontool.conf.airflow.utils.helpers import as_flattened_list
...
class HiveServer2Hook(DbApiHook):
    ...
    * the default for run_set_variable_statements is true, if you
    ...
    def get_records(
        ...
        >>> hh = HiveServer2Hook()
        >>> sql = "SELECT * from pythontool.conf.airflow.static_babynames LIMIT 100"
