...
from pythontool.conf.airflow.providers.apache.hive.hooks.hive import HiveMetastoreHook
from pythontool.conf.airflow.providers.mysql.hooks.mysql import MySqlHook
from pythontool.conf.airflow.providers.presto.hooks.presto import PrestoHook
