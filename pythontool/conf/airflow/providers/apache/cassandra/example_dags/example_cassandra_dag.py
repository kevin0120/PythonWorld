...
from pythontool.conf.airflow.providers.apache.cassandra.sensors.record import CassandraRecordSensor
from pythontool.conf.airflow.providers.apache.cassandra.sensors.table import CassandraTableSensor
