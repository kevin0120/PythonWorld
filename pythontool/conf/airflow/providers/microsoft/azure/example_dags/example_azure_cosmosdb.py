...
from pythontool.conf.airflow.providers.microsoft.azure.operators.cosmos import AzureCosmosInsertDocumentOperator
from pythontool.conf.airflow.providers.microsoft.azure.sensors.cosmos import AzureCosmosDocumentSensor
