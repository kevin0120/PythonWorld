...
from pythontool.conf.airflow.providers.microsoft.azure.operators.adls import ADLSDeleteOperator
from pythontool.conf.airflow.providers.microsoft.azure.transfers.local_to_adls import LocalFilesystemToADLSOperator
