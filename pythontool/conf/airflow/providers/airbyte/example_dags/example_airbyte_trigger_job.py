...
from pythontool.conf.airflow.providers.airbyte.operators.airbyte import AirbyteTriggerSyncOperator
from pythontool.conf.airflow.providers.airbyte.sensors.airbyte import AirbyteJobSensor
