...
from pythontool.conf.airflow.lineage import AUTO
from pythontool.conf.airflow.providers.papermill.operators.papermill import PapermillOperator
...
with DAG(
    ...
    run_this = PapermillOperator(
        ...
        parameters={"msgs": "Ran from pythontool.conf.airflow at {{ execution_date }}!"},
    )
...
def check_notebook(inlets, execution_date):
    ...
    if message.data != f"Ran from pythontool.conf.airflow at {execution_date}!":
        return False
