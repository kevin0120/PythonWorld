...
from pythontool.conf.airflow.exceptions import AirflowOptionalProviderFeatureException
...
class ProvidersManager(LoggingMixin):
    ...
    def _discover_all_airflow_builtin_providers_from_local_sources(self) -> None:
        ...
        try:
            ...
            log.warning("Error when loading 'provider.yaml' files from pythontool.conf.airflow sources: %s", e)
