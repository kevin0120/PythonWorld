...
from pythontool.conf.airflow import models, settings
from pythontool.conf.airflow.callbacks.callback_requests import DagCallbackRequest, SlaCallbackRequest, TaskCallbackRequest
from pythontool.conf.airflow.callbacks.database_callback_sink import DatabaseCallbackSink
from pythontool.conf.airflow.callbacks.pipe_callback_sink import PipeCallbackSink
from pythontool.conf.airflow.configuration import conf
from pythontool.conf.airflow.dag_processing.manager import DagFileProcessorAgent
from pythontool.conf.airflow.executors.executor_loader import UNPICKLEABLE_EXECUTORS
from pythontool.conf.airflow.jobs.base_job import BaseJob
from pythontool.conf.airflow.jobs.local_task_job import LocalTaskJob
from pythontool.conf.airflow.models import DAG
from pythontool.conf.airflow.models.dag import DagModel
...
from pythontool.conf.airflow.models.taskinstance import SimpleTaskInstance, TaskInstance, TaskInstanceKey
from pythontool.conf.airflow.stats import Stats
from pythontool.conf.airflow.ti_deps.dependencies_states import EXECUTION_STATES
from pythontool.conf.airflow.utils import timezone
from pythontool.conf.airflow.utils.docs import get_docs_url
from pythontool.conf.airflow.utils.event_scheduler import EventScheduler
from pythontool.conf.airflow.utils.retries import MAX_DB_RETRIES, retry_db_transaction, run_with_db_retries
from pythontool.conf.airflow.utils.session import create_session, provide_session
from pythontool.conf.airflow.utils.sqlalchemy import (
...
class SchedulerJob(BaseJob):
    ...
    def _executable_task_instances_to_queued(self, max_tis: int, session: Session = None) -> List[TI]:
        ...
        """
        from pythontool.conf.airflow.utils.db import DBLocks
