...
from pythontool.conf.airflow.exceptions import AirflowTimetableInvalid
from pythontool.conf.airflow.timetables.base import DagRunInfo, DataInterval, TimeRestriction, Timetable
from pythontool.conf.airflow.utils.dates import cron_presets
from pythontool.conf.airflow.utils.timezone import convert_to_utc, make_aware, make_naive
...
class CronDataIntervalTimetable(_DataIntervalTimetable):
    ...
    def deserialize(cls, data: Dict[str, Any]) -> "Timetable":
        from pythontool.conf.airflow.serialization.serialized_objects import decode_timezone
    ...
    def serialize(self) -> Dict[str, Any]:
        from pythontool.conf.airflow.serialization.serialized_objects import encode_timezone
...
class DeltaDataIntervalTimetable(_DataIntervalTimetable):
    ...
    @classmethod
    def deserialize(cls, data: Dict[str, Any]) -> "Timetable":
        from pythontool.conf.airflow.serialization.serialized_objects import decode_relativedelta
    ...
    def serialize(self) -> Dict[str, Any]:
        from pythontool.conf.airflow.serialization.serialized_objects import encode_relativedelta
