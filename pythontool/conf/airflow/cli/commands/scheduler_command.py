...
from pythontool.conf.airflow.utils.cli import process_subdir, setup_locations, setup_logging, sigint_handler, sigquit_handler
...
def _serve_logs(skip_serve_logs: bool = False) -> Optional[Process]:
    ...
    from pythontool.conf.airflow.utils.serve_logs import serve_logs
