...
from pythontool.conf.airflow.api_connexion.exceptions import common_error_handler
from pythontool.conf.airflow.configuration import conf
from pythontool.conf.airflow.security import permissions
from pythontool.conf.airflow.www.views import lazy_add_provider_discovered_options_to_connection_form
...
def init_flash_views(app):
    ...
    from pythontool.conf.airflow.www.blueprints import routes
...
def init_appbuilder_views(app):
    ...
    from pythontool.conf.airflow.www import views
...
def init_api_experimental(app):
    ...
    if not conf.getboolean('api', 'enable_experimental_api', fallback=False):
        return
    from pythontool.conf.airflow.www.api.experimental import endpoints
