...
import airflow
from pythontool.conf.airflow import models, plugins_manager, settings
from pythontool.conf.airflow.api.common.mark_tasks import (
    set_dag_run_state_to_failed,
    set_dag_run_state_to_queued,
    set_dag_run_state_to_success,
    set_state,
)
from pythontool.conf.airflow.compat.functools import cached_property
from pythontool.conf.airflow.configuration import AIRFLOW_CONFIG, conf
from pythontool.conf.airflow.exceptions import AirflowException, ParamValidationError
from pythontool.conf.airflow.executors.executor_loader import ExecutorLoader
from pythontool.conf.airflow.jobs.base_job import BaseJob
from pythontool.conf.airflow.jobs.scheduler_job import SchedulerJob
from pythontool.conf.airflow.jobs.triggerer_job import TriggererJob
from pythontool.conf.airflow.models import DAG, Connection, DagModel, DagTag, Log, SlaMiss, TaskFail, XCom, errors
from pythontool.conf.airflow.models.abstractoperator import AbstractOperator
from pythontool.conf.airflow.models.dagcode import DagCode
from pythontool.conf.airflow.models.dagrun import DagRun, DagRunType
from pythontool.conf.airflow.models.operator import Operator
from pythontool.conf.airflow.models.serialized_dag import SerializedDagModel
from pythontool.conf.airflow.models.taskinstance import TaskInstance
from pythontool.conf.airflow.providers_manager import ProvidersManager
from pythontool.conf.airflow.security import permissions
from pythontool.conf.airflow.ti_deps.dep_context import DepContext
from pythontool.conf.airflow.ti_deps.dependencies_deps import RUNNING_DEPS, SCHEDULER_QUEUED_DEPS
from pythontool.conf.airflow.timetables.base import DataInterval, TimeRestriction
from pythontool.conf.airflow.utils import json as utils_json, timezone, yaml
from pythontool.conf.airflow.utils.dates import infer_time_unit, scale_time_units
from pythontool.conf.airflow.utils.docs import get_doc_url_for_provider, get_docs_url
from pythontool.conf.airflow.utils.helpers import alchemy_to_dict
from pythontool.conf.airflow.utils.log import secrets_masker
from pythontool.conf.airflow.utils.log.log_reader import TaskLogReader
from pythontool.conf.airflow.utils.session import NEW_SESSION, create_session, provide_session
from pythontool.conf.airflow.utils.state import State, TaskInstanceState
from pythontool.conf.airflow.utils.strings import to_boolean
from pythontool.conf.airflow.utils.timezone import td_format, utcnow
from pythontool.conf.airflow.version import version
from pythontool.conf.airflow.www import auth, utils as wwwutils
from pythontool.conf.airflow.www.decorators import action_logging, gzipped
from pythontool.conf.airflow.www.forms import (
    ConnectionForm,
    DagRunEditForm,
    DateTimeForm,
...
from pythontool.conf.airflow.www.widgets import AirflowModelListWidget, AirflowVariableShowWidget
...
class AirflowBaseView(BaseView):
    ...
    from pythontool.conf.airflow import macros
...
class Airflow(AirflowBaseView):
    ...
    def index(self):
        ...
        from pythontool.conf.airflow.plugins_manager import import_errors as plugin_import_errors
    ...
    def delete(self):
        """Deletes DAG."""
        from pythontool.conf.airflow.api.common import delete_dag
        from pythontool.conf.airflow.exceptions import DagNotFound
