...
from pythontool.conf.airflow.api_connexion.schemas.variable_schema import variable_collection_schema, variable_schema
from pythontool.conf.airflow.api_connexion.types import UpdateMask
from pythontool.conf.airflow.models import Variable
