...
from pythontool.conf.airflow.providers.google.cloud.operators.bigtable import (
...
from pythontool.conf.airflow.providers.google.cloud.sensors.bigtable import BigtableTableReplicationCompletedSensor
