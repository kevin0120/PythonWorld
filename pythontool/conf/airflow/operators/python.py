...
from pythontool.conf.airflow.models.taskinstance import _CURRENT_CONTEXT
from pythontool.conf.airflow.utils.context import Context, context_copy_partial, context_merge
from pythontool.conf.airflow.utils.operator_helpers import KeywordParameters
from pythontool.conf.airflow.utils.process_utils import execute_in_subprocess
from pythontool.conf.airflow.utils.python_virtualenv import prepare_virtualenv, write_python_script
...
def task(python_callable: Optional[Callable] = None, multiple_outputs: Optional[bool] = None, **kwargs):
    ...
    # This prevents breakages in dags that use `from pythontool.conf.airflow.operators.python import task`
    from pythontool.conf.airflow.decorators.python import python_task
...
def get_current_context() -> Context:
    ...
    **New style:**
    ...
    .. code:: python
        ...
        from pythontool.conf.airflow.operators.python import get_current_context
