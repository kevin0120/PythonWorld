...
from pythontool.conf.airflow.compat.functools import cache
from pythontool.conf.airflow.configuration import conf
from pythontool.conf.airflow.exceptions import (
    AirflowException,
...
from pythontool.conf.airflow.models.base import COLLATION_ARGS, ID_LEN, Base
from pythontool.conf.airflow.models.log import Log
from pythontool.conf.airflow.models.param import ParamsDict
from pythontool.conf.airflow.models.taskfail import TaskFail
from pythontool.conf.airflow.models.taskmap import TaskMap
...
from pythontool.conf.airflow.plugins_manager import integrate_macros_plugins
from pythontool.conf.airflow.sentry import Sentry
from pythontool.conf.airflow.stats import Stats
from pythontool.conf.airflow.templates import SandboxedEnvironment
from pythontool.conf.airflow.ti_deps.dep_context import DepContext
from pythontool.conf.airflow.ti_deps.dependencies_deps import REQUEUEABLE_DEPS, RUNNING_DEPS
from pythontool.conf.airflow.timetables.base import DataInterval
from pythontool.conf.airflow.typing_compat import Literal
from pythontool.conf.airflow.utils import timezone
from pythontool.conf.airflow.utils.context import ConnectionAccessor, Context, VariableAccessor, context_merge
from pythontool.conf.airflow.utils.email import send_email
from pythontool.conf.airflow.utils.helpers import render_template_to_string
from pythontool.conf.airflow.utils.log.logging_mixin import LoggingMixin
from pythontool.conf.airflow.utils.net import get_hostname
from pythontool.conf.airflow.utils.operator_helpers import context_to_airflow_vars
from pythontool.conf.airflow.utils.platform import getuser
from pythontool.conf.airflow.utils.retries import run_with_db_retries
from pythontool.conf.airflow.utils.session import NEW_SESSION, create_session, provide_session
from pythontool.conf.airflow.utils.sqlalchemy import ExtendedJSON, UtcDateTime, tuple_in_condition, with_row_locks
from pythontool.conf.airflow.utils.state import DagRunState, State, TaskInstanceState
from pythontool.conf.airflow.utils.timeout import timeout
...
if TYPE_CHECKING:
    ...
    from pythontool.conf.airflow.models.dag import DAG, DagModel
...
def clear_task_instances(
    ...
    if dag_run_state is not False and tis:
        from pythontool.conf.airflow.models.dagrun import DagRun  # Avoid circular import
...
class TaskInstance(Base, LoggingMixin):
    ...
    def render_k8s_pod_yaml(self) -> Optional[dict]:
        ...
        from pythontool.conf.airflow.kubernetes.kube_config import KubeConfig
        from pythontool.conf.airflow.kubernetes.kubernetes_helper_functions import create_pod_id  # Circular import
        from pythontool.conf.airflow.kubernetes.pod_generator import PodGenerator
