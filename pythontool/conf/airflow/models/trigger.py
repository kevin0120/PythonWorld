...
from pythontool.conf.airflow.utils.sqlalchemy import ExtendedJSON, UtcDateTime
...
class Trigger(Base):
    ...
    def assign_unassigned(cls, triggerer_id, capacity, session=None):
        ...
        """
        from pythontool.conf.airflow.jobs.base_job import BaseJob  # To avoid circular import
