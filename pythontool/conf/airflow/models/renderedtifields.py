...
from pythontool.conf.airflow.models.base import Base, StringID
...
from pythontool.conf.airflow.utils.retries import retry_db_transaction
...
class RenderedTaskInstanceFields(Base):
    ...
    def _redact(self):
        from pythontool.conf.airflow.utils.log.secrets_masker import redact
