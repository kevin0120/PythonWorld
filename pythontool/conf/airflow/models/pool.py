...
from pythontool.conf.airflow.exceptions import AirflowException, PoolNotFound
...
from pythontool.conf.airflow.typing_compat import TypedDict
from pythontool.conf.airflow.utils.session import NEW_SESSION, provide_session
from pythontool.conf.airflow.utils.sqlalchemy import nowait, with_row_locks
...
class Pool(Base):
    ...
    def slots_stats(
        *,
        ...
        :param session: SQLAlchemy ORM Session
        """
        from pythontool.conf.airflow.models.taskinstance import TaskInstance  # Avoid circular import
