...
from pythontool.conf.airflow.exceptions import AirflowException, TaskDeferred
from pythontool.conf.airflow.lineage import apply_lineage, prepare_lineage
from pythontool.conf.airflow.models.abstractoperator import (
    DEFAULT_OWNER,
    DEFAULT_POOL_SLOTS,
...
from pythontool.conf.airflow.models.mappedoperator import OperatorPartial, validate_mapping_kwargs
...
from pythontool.conf.airflow.models.taskmixin import DAGNode, DependencyMixin
from pythontool.conf.airflow.models.xcom import XCOM_RETURN_KEY
from pythontool.conf.airflow.serialization.enums import DagAttributeTypes
from pythontool.conf.airflow.ti_deps.deps.base_ti_dep import BaseTIDep
from pythontool.conf.airflow.ti_deps.deps.not_in_retry_period_dep import NotInRetryPeriodDep
from pythontool.conf.airflow.ti_deps.deps.not_previously_skipped_dep import NotPreviouslySkippedDep
from pythontool.conf.airflow.ti_deps.deps.prev_dagrun_dep import PrevDagrunDep
from pythontool.conf.airflow.ti_deps.deps.trigger_rule_dep import TriggerRuleDep
from pythontool.conf.airflow.triggers.base import BaseTrigger
from pythontool.conf.airflow.utils import timezone
from pythontool.conf.airflow.utils.context import Context
from pythontool.conf.airflow.utils.helpers import validate_key
from pythontool.conf.airflow.utils.operator_resources import Resources
...
from pythontool.conf.airflow.utils.weight_rule import WeightRule

if TYPE_CHECKING:
    import jinja2  # Slow import.

    from pythontool.conf.airflow.models.dag import DAG
    from pythontool.conf.airflow.models.taskinstance import TaskInstanceKey
...
def partial(
    ...
    **kwargs,
    ...
    from pythontool.conf.airflow.models.dag import DagContext
    from pythontool.conf.airflow.utils.task_group import TaskGroupContext
...
class BaseOperator(AbstractOperator, metaclass=BaseOperatorMeta):
    ...
    def set_xcomargs_dependencies(self) -> None:
        ...
        **Example**: ::
        ...
        """
        from pythontool.conf.airflow.models.xcom_arg import XComArg
    ...
    def get_task_instances(
        ...
        from pythontool.conf.airflow.models import DagRun
    ...
    def run(
        ...
        from pythontool.conf.airflow.models import DagRun
        from pythontool.conf.airflow.utils.types import DagRunType
