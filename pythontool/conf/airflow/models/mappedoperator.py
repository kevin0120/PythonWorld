...
from pythontool.conf.airflow.compat.functools import cache, cached_property
from pythontool.conf.airflow.exceptions import AirflowException, UnmappableOperator
...
from pythontool.conf.airflow.ti_deps.deps.mapped_task_expanded import MappedTaskIsExpanded
from pythontool.conf.airflow.typing_compat import Literal
from pythontool.conf.airflow.utils.context import Context
from pythontool.conf.airflow.utils.helpers import is_container
...
from pythontool.conf.airflow.utils.types import NOTSET
...
def ensure_xcomarg_return_value(arg: Any) -> None:
    from pythontool.conf.airflow.models.xcom_arg import XCOM_RETURN_KEY, XComArg
...
class OperatorPartial:
    ...
    def expand(self, **mapped_kwargs: "Mappable") -> "MappedOperator":
        ...
        from pythontool.conf.airflow.operators.empty import EmptyOperator
...
class MappedOperator(AbstractOperator):
    ...
    def unmap(self, unmap_kwargs: Optional[Dict[str, Any]] = None) -> "BaseOperator":
        ...
        from pythontool.conf.airflow.serialization.serialized_objects import SerializedBaseOperator
    ...
    def _get_map_lengths(self, run_id: str, *, session: Session) -> Dict[str, int]:
        ...
        from pythontool.conf.airflow.models.xcom import XCom
        from pythontool.conf.airflow.models.xcom_arg import XComArg
    ...
    def expand_mapped_task(self, run_id: str, *, session: Session) -> Tuple[Sequence["TaskInstance"], int]:
        ...
        """
        from pythontool.conf.airflow.models.taskinstance import TaskInstance
        from pythontool.conf.airflow.settings import task_instance_mutation_hook
