...
from pythontool.conf.airflow.utils.helpers import render_template_as_native, render_template_to_string
...
class AbstractOperator(LoggingMixin, DAGNode):
    ...
    The union type ``from pythontool.conf.airflow.models.operator import Operator`` is easier
    ...
    def render_template(
        ...
        from pythontool.conf.airflow.models.param import DagParam
