...
from pythontool.conf.airflow.utils.file import correct_maybe_zipped, list_py_file_paths, might_contain_dag
from pythontool.conf.airflow.utils.log.logging_mixin import LoggingMixin
from pythontool.conf.airflow.utils.retries import MAX_DB_RETRIES, run_with_db_retries
from pythontool.conf.airflow.utils.session import provide_session
...
class DagBag(LoggingMixin):
    ...
    def _process_modules(self, filepath, mods, file_last_changed_on_disk):
        from pythontool.conf.airflow.models.dag import DAG  # Avoid circular import
    ...
    def _sync_perm_for_dag(self, dag, session: Session = None):
        ...
        from pythontool.conf.airflow.security.permissions import DAG_ACTIONS, resource_name_for_dag
        from pythontool.conf.airflow.www.fab_security.sqla.models import Action, Permission, Resource
        ...
        if dag.access_control or needs_perms(dag.dag_id):
            ...
            from pythontool.conf.airflow.www.security import ApplessAirflowSecurityManager
