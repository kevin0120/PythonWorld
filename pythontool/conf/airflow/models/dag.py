...
from pythontool.conf.airflow import settings, utils
...
from pythontool.conf.airflow.exceptions import AirflowException, DuplicateTaskIdFound, TaskNotFound
...
from pythontool.conf.airflow.models.param import DagParam, ParamsDict
from pythontool.conf.airflow.models.taskinstance import Context, TaskInstance, TaskInstanceKey, clear_task_instances
from pythontool.conf.airflow.security import permissions
from pythontool.conf.airflow.stats import Stats
from pythontool.conf.airflow.timetables.base import DagRunInfo, DataInterval, TimeRestriction, Timetable
from pythontool.conf.airflow.timetables.interval import CronDataIntervalTimetable, DeltaDataIntervalTimetable
from pythontool.conf.airflow.timetables.simple import NullTimetable, OnceTimetable
from pythontool.conf.airflow.typing_compat import Literal, RePatternType
from pythontool.conf.airflow.utils import timezone
from pythontool.conf.airflow.utils.dag_cycle_tester import check_cycle
from pythontool.conf.airflow.utils.dates import cron_presets, date_range as utils_date_range
from pythontool.conf.airflow.utils.file import correct_maybe_zipped
from pythontool.conf.airflow.utils.helpers import exactly_one, validate_key
from pythontool.conf.airflow.utils.log.logging_mixin import LoggingMixin
from pythontool.conf.airflow.utils.session import NEW_SESSION, provide_session
from pythontool.conf.airflow.utils.sqlalchemy import Interval, UtcDateTime, skip_locked, tuple_in_condition, with_row_locks
from pythontool.conf.airflow.utils.state import DagRunState, State, TaskInstanceState
from pythontool.conf.airflow.utils.types import NOTSET, ArgNotSet, DagRunType, EdgeInfoType

if TYPE_CHECKING:
    from pythontool.conf.airflow.decorators import TaskDecoratorCollection
    from pythontool.conf.airflow.models.slamiss import SlaMiss
    from pythontool.conf.airflow.utils.task_group import TaskGroup
...
class DAG(LoggingMixin):
    ...
    def previous_schedule(self, dttm):
        from pythontool.conf.airflow.timetables.interval import _DataIntervalTimetable
    ...
    def subdags(self):
        ...
        from pythontool.conf.airflow.operators.subdag import SubDagOperator
    ...
    def _get_task_instances(
        ...
        *,
        ...
        if include_dependent_dags:
            ...
            from pythontool.conf.airflow.sensors.external_task import ExternalTaskMarker
    ...
    def set_task_instance_state(
        ...
        *,
        ...
        """
        from pythontool.conf.airflow.api.common.mark_tasks import set_state
    ...
    def partial_subset(
        ...
        from pythontool.conf.airflow.models.baseoperator import BaseOperator
    ...
    def run(
        ...
        """
        from pythontool.conf.airflow.jobs.backfill_job import BackfillJob

        if not executor and local:
            from pythontool.conf.airflow.executors.local_executor import LocalExecutor
