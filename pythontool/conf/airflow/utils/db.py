...
from pythontool.conf.airflow.compat.sqlalchemy import has_table
from pythontool.conf.airflow.configuration import conf
from pythontool.conf.airflow.exceptions import AirflowException
from pythontool.conf.airflow.jobs.base_job import BaseJob  # noqa: F401
from pythontool.conf.airflow.models import (  # noqa: F401
    DAG,
    XCOM_RETURN_KEY,
    Base,
    BaseOperator,
...
from pythontool.conf.airflow.models.serialized_dag import SerializedDagModel  # noqa: F401
from pythontool.conf.airflow.models.tasklog import LogTemplate
from pythontool.conf.airflow.utils import helpers

# TODO: remove create_session once we decide to break backward compatibility
from pythontool.conf.airflow.utils.session import NEW_SESSION, create_session, provide_session  # noqa: F401
...
def drop_airflow_models(connection):
    ...
    :return: None
    """
    from pythontool.conf.airflow.models.base import Base
...
def drop_airflow_moved_tables(session):
    from pythontool.conf.airflow.models.base import Base
    from pythontool.conf.airflow.settings import AIRFLOW_MOVED_TABLE_PREFIX
