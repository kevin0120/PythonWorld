...
from pythontool.conf.airflow.exceptions import AirflowDagCycleException, AirflowException, DuplicateTaskIdFound
...
from pythontool.conf.airflow.utils.helpers import validate_group_key

if TYPE_CHECKING:
    from pythontool.conf.airflow.models.baseoperator import BaseOperator
    from pythontool.conf.airflow.models.dag import DAG
    from pythontool.conf.airflow.utils.edgemodifier import EdgeModifier
...
class TaskGroup(DAGNode):
    ...
    def serialize_for_task_group(self) -> Tuple[DagAttributeTypes, Any]:
        """Required by DAGNode."""
        from pythontool.conf.airflow.serialization.serialized_objects import SerializedTaskGroup
    ...
    def topological_sort(self, _include_subdag_tasks: bool = False):
        ...
        from pythontool.conf.airflow.operators.subdag import SubDagOperator  # Avoid circular import
