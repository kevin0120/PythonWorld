...
from pythontool.conf.airflow.secrets import DEFAULT_SECRETS_SEARCH_PATH, BaseSecretsBackend
...
class AirflowConfigParser(ConfigParser):
    ...
    def as_dict(
        ...
        :param include_env: Should the value of configuration from pythontool.conf.airflow__
