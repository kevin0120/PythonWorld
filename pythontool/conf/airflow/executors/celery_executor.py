...
from pythontool.conf.airflow.config_templates.default_celery import DEFAULT_CELERY_CONFIG
...
from pythontool.conf.airflow.executors.base_executor import BaseExecutor, CommandType, EventBufferValueType, TaskTuple
...
from pythontool.conf.airflow.utils.timezone import utcnow
...
def _execute_in_fork(command_to_exec: CommandType, celery_task_id: Optional[str] = None) -> None:
    ...
    ret = 1
    try:
        from pythontool.conf.airflow.cli.cli_parser import get_parser
