...
from pythontool.conf.airflow.configuration import AIRFLOW_HOME, WEBSERVER_CONFIG, conf  # NOQA F401
...
from pythontool.conf.airflow.utils.orm_event_handlers import setup_event_handlers

if TYPE_CHECKING:
    from pythontool.conf.airflow.www.utils import UIAlert
...
def configure_vars():
    """Configure Global Variables from pythontool.conf.airflow.cfg"""
