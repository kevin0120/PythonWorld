...
from pythontool.conf.configration import settings
from pythontool.conf.configration import version
...
print("settings.initialize(){}".format("sys path 增加了dags config plugins"))
settings.initialize()
...
if not settings.LAZY_LOAD_PROVIDERS:
    from pythontool.conf.airflow import providers_manager
