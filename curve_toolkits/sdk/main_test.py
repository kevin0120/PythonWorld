from sdk.sdk import doCACurveEncode
import os
...
def callEncode(mode):
    ...
    doCACurveEncode(bolt_number, craft_type, mode, curve_param, curve_meta_data)
...
def test_encode():
    ...
    try:
        ...
        print('test_encode error, mode=0, {}'.format(repr(e)))
    try:
        callEncode(1)
    except Exception as e:
        print('test_encode error, mode=1, {}'.format(repr(e)))


if __name__ == '__main__':
    # initCurveLib(CURVE_LIB_PATH)
    test_encode()
